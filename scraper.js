...
const scraper = async(link_url) => {
    ...
    result = await page.evaluate(() => {
        return Array.from(document.querySelectorAll(".gallery-item[class$=GalleryProduct]"))
            .map(product => ({
                brand: product.querySelector("div[class$='GalleryProduct'] h2:first-of-type") ? product.querySelector("div[class$='GalleryProduct'] h2:first-of-type").textContent : "",
                name: product.querySelector("div[class$='GalleryProduct'] h2:last-of-type") ? product.querySelector("div[class$='GalleryProduct'] h2:last-of-type").textContent : "",
                ...
                image: product.querySelector('.image[class$="ImageBlock"]') ? getComputedStyle(product.querySelector(".image[class$='ImageBlock']")).backgroundImage.split('"')[1] : "",
